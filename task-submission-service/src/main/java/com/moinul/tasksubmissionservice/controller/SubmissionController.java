...
import com.moinul.tasksubmissionservice.service.SubmissionService;
import com.moinul.tasksubmissionservice.service.TaskService;
import com.moinul.tasksubmissionservice.service.UserService;
...
public class SubmissionController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Submission> acceptOrDeclinedSubmission(
            @PathVariable Long id,
